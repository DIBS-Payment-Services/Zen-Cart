...
class dibs_fw_helpers extends dibs_fw_helpers_cms implements dibs_fw_helpers_interface {
     ...
     * @return string 
     */
    function helper_dibs_tools_conf($sVar, $sPrefix = 'DIBSFLEX_') {
    ...
    function helper_dibs_tools_lang($sKey, $sType="msg") {
        $sName = strtoupper("MODULE_PAYMENT_DIBSFLEX_" . $sType . "_" . $sKey);
        return defined($sName) ? constant($sName) : "";
    }
    ...
    function helper_dibs_tools_url($sLink) {
        return ((defined('ENABLE_SSL') && ENABLE_SSL == 'true') ? 
               HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG . $sLink;
    }
    ...
    function helper_dibs_obj_order($mOrderInfo, $bResponse = FALSE) {
        ...
        if($bResponse === TRUE) {
            ...
            return (object)array(
                ...
                'currency' => dibs_fw_api::api_dibs_get_currencyValue($mOrderInfo->info['currency'])
            );
        }
    }
    ...
    function helper_dibs_obj_urls($mOrderInfo = null) {
        return (object)array(
            'acceptreturnurl' => "ext/modules/payment/dibsflex/success.php",
            'callbackurl'     => "ext/modules/payment/dibsflex/callback.php",
            'cancelreturnurl' => "ext/modules/payment/dibsflex/cancel.php",
            'cgiurl'          => "../ext/modules/payment/dibsflex/cgiapi.php",
    ...
    function helper_dibs_obj_etc($mOrderInfo) {
        return (object)array(
            'sysmod'      => 'znc1_3_0_3',
            'callbackfix' => $this->helper_dibs_tools_url("ext/modules/payment/dibsflex/callback.php")
        );
    }
}
?>