...
class dibspw extends dibs_pw_api {
        ...
        $this->installApply(array(
                              ...
                              array('title' => 'HMAC:', 
                                ...
                                array('title' => 'Paytype:', 
                                      ...
                                      'ufunc' => 'NULL', 
                                      'sfunc' => 'NULL'),
                                array('title' => 'Logo(s) to display:', 
                                      'cfkey' => 'MODULE_PAYMENT_DIBS_LOGOS', 
                                      'value' => 'VISA,MC', 
                                      'descr' => 'This list must be comma separated with 
                                                  no spaces in between. E.g. VISA,MC', 
                                      'order' => 12, 
                                      'ufunc' => 'NULL', 
                                      'sfunc' => 'NULL'),
                                array('title' => 'Are you using 3-D Secure:', 
                                      'cfkey' => 'MODULE_PAYMENT_DIBS_3DSECURE', 
                                      'value' => 'no', 
                                      'descr' => 'Select yes if you want to present 3-D Secure logo(s). Note that it only works if logo(s) are defined above.)', 
                                      'order' => 13, 
                                      'ufunc' => 'NULL', 
                                      'sfunc' => "'zen_cfg_select_option(array(\'yes\', \'no\'),'"),
                                ...
                                array('title' => 'Set order status', 
                                      ...
                                      'order' => 17, 
                                      'ufunc' => "'zen_get_order_status_name'",
                                      'sfunc' => "'zen_cfg_pull_down_order_statuses('"),
                                array('title' => 'Payment zone:', 
                                      ...
                                      'order' => 18, 
                                      'ufunc' => "'zen_get_zone_class_title'",
                                      'sfunc' => "'zen_cfg_pull_down_zone_classes('"),
    ...
    function keys() {
        return array('MODULE_PAYMENT_DIBSPW_STATUS', 
                     ...
                     'MODULE_PAYMENT_DIBS_LOGOS', 'MODULE_PAYMENT_DIBS_3DSECURE',
